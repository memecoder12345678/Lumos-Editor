...
4.  **(Optional) Apply Themes:**
    -   Replace the `theme.json` file in the `src` folder with your preferred code highlight theme(you can browse the available `themes` in the project's themes directory).
